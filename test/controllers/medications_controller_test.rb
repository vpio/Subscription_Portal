...
class MedicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medication" do
    assert_difference('Medication.count') do
      post medications_url, params: { medication: { duration_of_supply_in_months: @medication.duration_of_supply_in_months, name: @medication.name, price: @medication.price } }
    end
  ...
  test "should update medication" do
    patch medication_url(@medication), params: { medication: { duration_of_supply_in_months: @medication.duration_of_supply_in_months, name: @medication.name, price: @medication.price } }
